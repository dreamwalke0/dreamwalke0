...
Начинающий разработчик, который развивается в frontend и backend направлениях. Создаю веб-приложения, изучаю новые технологии и стараюсь писать простой и качественный код. Интересуюсь разработкой, автоматизацией и созданием полезных проектов.
